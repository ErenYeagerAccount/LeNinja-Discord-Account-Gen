...
The LeNinja browser extension is automatically downloaded on first run. Use **Ungoogled Chromium** (recommended). Chrome, Brave, Edge, and Thorium are not launched automatically.
